...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/TechnoGarv/TECH-BOMB.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/TechnoGarv/TECH-BOMB.git HEAD")
    sys.exit()
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("TechBomb will work only in Python v3")
    sys.exit()
